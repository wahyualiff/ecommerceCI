...
class Global_data extends CI_Model
{
	...
	function getLabelCOD($cod = 1)
	{
		switch ($cod) {
			case 0:
				$label = "<span class='label tooltip'>Rekber Saja<span class='tooltiptext'>produk ini hanya bisa dibeli melalui rekber BELIWARGA</span></span>";
				break;
			case 1:
				$label = "<span class='label tooltip'>Rekber<span class='tooltiptext'>produk ini bisa dibeli melalui rekber BELIWARGA</span></span><span class='label tooltip'>COD<span class='tooltiptext'>produk ini bisa dibeli langsung dengan bertemu penjual tanpa melalui rekber</span></span>";
				break;
			case 2:
				$label = "<span class='label tooltip'>COD Saja<span class='tooltiptext'>produk ini hanya bisa dibeli langsung dengan bertemu penjual</span></span>";
				break;
		}
		return $label;
	}
