...
<div class="container">
	<div class="bread-crumb">
		...
		?>
		<a href="<?php echo site_url("kategori/" . $kategori->url); ?>" class="text-warning">
			...
			<div class="col-md-6 col-lg-7 p-b-30">
				<div class="p-l-25 p-r-30 p-lr-0-lg">
					...
					?>
							<div class="prod-preview">
								<img src="<?php echo base_url("admin/uploads/" . $res->nama); ?>" alt="IMG-PRODUCT" id="prod-img">
							</div>
							...
							?>
							<div class="prod-thumb-item" data-thumb="<?php echo base_url("admin/uploads/" . $res->nama); ?>" style="background-image:url('<?php echo base_url("admin/uploads/" . $res->nama); ?>');"></div>
						<?php
						if ($no == $db->num_rows()) {
							echo "</div>";
						}
				...
				<div class="col-md-6 col-lg-5 p-b-20">
					<div class="p-t-5 p-lr-0-lg">
						...
						<span id="hargacetak" class="fs-24 font-bold text-warning color1">
							<?php
							if ($hargs > 0) {
...
<section class="sec-relate-product p-t-45 p-b-105">
	<div class="container">
		<div class="p-b-45">
			<h3 class="t-center font-bold text-warning">
				Produk Terkait
			</h3>
		</div>
