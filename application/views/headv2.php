...
$nama = ($this->func->demo() == true) ? $nama . " App by @mycodingxd 082377823390" : $nama;
...
$keywords = "";
$img = (isset($img)) ? $img : base_url("admin/assets/img/" . $set->favicon);
		...
		<nav class="navbar navbar-expand-lg navbar-light fixed-top">
			<div class="container">
				<a class="navbar-brand" href="<?= site_url() ?>">
					<img src="<?= base_url('admin/assets/img/' . $set->logo) ?>" height="60" />
				</a>
				...
				<div class="collapse navbar-collapse" id="navbarToggler">
					<ul class="navbar-nav mr-auto mt-2 mt-lg-0">
						<li class="nav-item active">
							<a class="nav-link" style="color: #F1F8FF;" href="<?= site_url() ?>"><b>Home</b> </a>
						</li>
						<li class="nav-item">
							<a class="nav-link" style="color: #F1F8FF;" href="<?= site_url("shop") ?>"><b>Produk</b></a>
						</li>
						<!-- <li class="nav-item">
						...
						<?php if ($this->func->cekLogin() == true) { ?>
							...
							<li class="nav-item dropdown">
								...
								<div class="dropdown-menu" aria-labelledby="navbarDropdown">
									...
									<a class="dropdown-item" href="javascript:signoutNow()">Keluar</a>
								</div>
							</li>
						<?php } ?>
					</ul>
