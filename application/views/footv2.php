...
<footer class="bg-foot p-t-40 p-b-40" style="margin-top: -2px;">
	<div class="row p-b-90 container m-l-auto m-r-auto">
		<div class="col-md-3 m-b-30">
			<h4 class="font-medium ff-secondary foot-title p-b-30">
				KONTAK
			</h4>

			<div class="">
				<?php $set = $this->func->getSetting("semua"); ?>
				<p style="color: #F1F8FF;">
					<?= $set->jamkerja ?>
				</p>
				&nbsp;
				<table>
					<tr>
						<td class='p-r-10' style="color: #FEA116;"><i class="fa fa-phone color1"></i></td>
						<td style="color: #F1F8FF;"><?= $set->wasap ?></td>
					</tr>
					<tr>
						<td class='p-r-10' style="color: #FEA116;"><i class="fa fa-square color1"></i> </td>
						<td style="color: #F1F8FF;"><?= $set->lineid ?></td>
					</tr>
					<tr>
						<td class='p-r-10' style="color: #FEA116;"><i class="fa fa-envelope-open color1"></i> </td>
						<td style="color: #F1F8FF;"><?= $set->email ?></td>
					</tr>
					<tr>
						<td class='p-r-10' style="color: #FEA116;"><i class="fa fa-map-marker color1"></i> </td>
						<td style="color: #F1F8FF;"><?= $set->alamat ?></td>
					</tr>
				</table>
			</div>

			<h4 class="font-medium ff-secondary foot-title p-b-10 p-t-30">
				Sosial Media
			</h4>
			<div class="">
		...
		<div class="col-md-3 m-b-30">
			<h4 class="font-medium ff-secondary foot-title p-b-10">
				Pembayaran
			</h4>

			<div class="flex-m p-t-10">
				<img style="width:100%;" src="<?= base_url("assets/images/bank-transfer.png") ?>" />
			</div>
	...
	<div class="t-center p-l-15 p-r-15">
		<div class="t-center p-t-20" style="color: #F1F8FF;">
