		...
		<form id="produk" action="" method="POST">
				...
				<div class="card-body">
					...
					<!-- <div class="row p-lr-15">
						<div class="form-group col-md-6">
							...
							<input type="text" class="form-control" placeholder="contoh: Warna" name="variasi" value="<?php echo ($id != 0) ? $data->variasi : ""; ?>" />
						</div>
						<div class="form-group col-md-6">
							<label>Nama Sub Variasi</label>
							<input type="text" class="form-control" placeholder="contoh: Size" name="subvariasi" value="<?php echo ($id != 0) ? $data->subvariasi : ""; ?>" />
						</div>
			...
			<div class="card">
				...
				<div class="card-body">
					...
					<div class="form-group row m-lr-0 novariasi">
						<label class="col-12 p-lr-0">Harga IDR</label>
						<input type="number" class="form-control col-md-6" name="harga" value="<?php echo ($id != 0) ? $data->harga : 0; ?>" required />
						<small class="col-md-6"><i>hanya masukkan angka saja. cth: 200000</i></small>
					</div>
					<!-- <div class="form-group row m-lr-0 novariasi">
						<label class="col-12 p-lr-0">Harga USD</label>
						<input type="text" class="form-control col-md-6" name="hargareseller" value="<?php echo ($id != 0) ? $data->hargareseller : 0; ?>" required />
